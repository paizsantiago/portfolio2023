...
const Main: React.FC = () => {
  ...
  return (
    <div id="main" className='flex flex-col justify-around bg-fondoMain h-[100%] lg:col-span-9 lg:row-span-1 '>
        <div className='text-center flex flex-col justify-center h-[100vh] '>
          <motion.h1 initial={{x: -400, opacity:0}} animate={{x: 0, opacity: 1}} transition={{duration: 1, delay: .3, type: "tween"}} className="text-2xl lg:text-5xl text-slate-900">
              Hola,
          ...
          <motion.h2 initial={{x: -300, opacity:0}} animate={{x: 0, opacity: 1}} transition={{duration: 1, delay: .3, type: "tween"}} className="text-2xl lg:text-5xl text-slate-900 text-center mb-5">y soy<span className='tracking-wide block p-2 text-5xl lg:text-8xl font-semibold'>Desarrollador<br/>Fullstack</span></motion.h2>
        </div>
